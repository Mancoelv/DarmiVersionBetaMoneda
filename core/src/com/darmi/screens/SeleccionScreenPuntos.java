...
public class SeleccionScreenPuntos extends BaseScreen{
    private Stage stage;
    private Skin skin;
    ...
    public SeleccionScreenPuntos(final MainGame game) {
        super(game);
        //asignamos el sonido de la tecla llamando al main
        tecla=game.getManager().get("tecla.ogg");
        //definimos el stage
        ...
        red = new TextButton("Naranja", skin);
        ...
        blue.addCaptureListener(new ChangeListener() {
            ...
            public void changed(ChangeEvent event, Actor actor) {
                ...
                game.gameScreenPuntos = new GameScreenPuntos(game);
                game.setScreen(game.gameScreenPuntos);
            }
        });
